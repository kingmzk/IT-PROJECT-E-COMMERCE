...
{
    public partial class CartDetails4 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (isformvalid())
            {
                ...
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand("Insert into tblCart3(Name,Email,PhoneNo,Company,Comment) Values('" + txtNamess.Text + "','" + txtEmailss.Text + "','" + txtPhoness.Text + "','" + txtCompanyss.Text + "','" + txtCom.Text + "')", con);
                    cmd.ExecuteNonQuery();
                    ...
                    Session["Band"] = txtquantity.Text;


                }
                Response.Redirect("~/CartResult4.aspx");
            }
            else
            {
