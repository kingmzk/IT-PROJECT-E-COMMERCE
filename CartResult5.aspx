        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="info">
                    ...
                    <asp:Button ID="btnFoot" class="btn btn-primary btn-lg" runat="server"  Text="Sucessfully Added" OnClick="btnFoot_Click"  />
                </div>
            </div>
            <asp:Label ID="lblwear" runat="server" Text="Your item Quantity is 0"></asp:Label>
        </div>
                     <!--Footer content-->
        <hr />
        <footer >
