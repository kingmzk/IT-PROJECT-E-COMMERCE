<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CartDetails4.aspx.cs" Inherits="IT_PROJECT_FOR_CUSTOMER_E_COMMERCE.CartDetails4" %>
        ...
        <>
         ...
         <div class="box">
            ...
            <div class="content">
                ...
                <div class="info">
                      <h3>$60</h3>
                    <asp:Button ID="btnBand" class="btn btn-primary btn-lg" runat="server" Text="Add-To-Cart" />
                </div>
            </div>
        </div>
