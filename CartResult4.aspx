<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CartResult4.aspx.cs" Inherits="IT_PROJECT_FOR_CUSTOMER_E_COMMERCE.CartResult4" %>
         ...
         <div class="box">
            ...
            <div class="content">
                ...
                <div class="info">
                    ...
                    <asp:Button ID="btnBand" class="btn btn-primary btn-lg" runat="server"  Text="Sucessfully Added" OnClick="btnBand_Click"/>
                </div>
            </div>
        </div>
    <asp:Label ID="lblband" runat="server" Text="Your item Quantity is 0"></asp:Label>
    </div>
                     <!--Footer content-->
        <hr />
        <footer >
