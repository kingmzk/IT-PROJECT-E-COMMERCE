<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CartResult3.aspx.cs" Inherits="IT_PROJECT_FOR_CUSTOMER_E_COMMERCE.CartResult3" %>
 ...
 <div class="box">
         ...
         <div class="box">
            ...
            <div class="content">
                ...
                <div class="info">
                     <h3>$50</h3>
                     <h4>(all tax included)</h4>
                    <asp:Button ID="btnJacket" class="btn btn-primary btn-lg" runat="server"  Text="Sucessfully Added" OnClick="btnJacket_Click"  />
                </div>
            </div>
    <asp:Label ID="Lbljacket" runat="server" Text="Your item Quantity is 0"></asp:Label>
        </div>
                     <!--Footer content-->
        <hr />
        <footer >
