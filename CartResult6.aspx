<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CartResult6.aspx.cs" Inherits="IT_PROJECT_FOR_CUSTOMER_E_COMMERCE.CartResult6" %>
            ...
            <div class="content">
                ...
                <div class="info">
                   <h3>$150</h3>
                    ...
                    <asp:Button ID="btnChair" class="btn btn-primary btn-lg" runat="server"  Text="Sucessfully Added" OnClick="btnChair_Click" />
                </div>
            </div>
    <asp:Label ID="lbloffice" runat="server" Text="Your item Quantity is 0"></asp:Label>
        </div>
                     <!--Footer content-->
        <hr />
        <footer >
