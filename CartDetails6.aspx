<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CartDetails6.aspx.cs" Inherits="IT_PROJECT_FOR_CUSTOMER_E_COMMERCE.CartDetails6" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="info">
                   <h3>$150</h3>
                    <asp:Button ID="btnChair" class="btn btn-primary btn-lg" runat="server" Text="Add-To-Cart" />
                </div>
            </div>
        </div>
