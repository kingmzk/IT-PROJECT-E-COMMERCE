<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CartResultL.aspx.cs" Inherits="IT_PROJECT_FOR_CUSTOMER_E_COMMERCE.CartResult" %>
...
<br /><br /><br />
            ...
            <div class="content">
                ...
                <div class="info">
                    ...
                    <asp:Button ID="btnLap" class="btn btn-primary btn-lg" runat="server" Text="Sucessfully Added" OnClick="btnLap_Click" />
                    
                </div>
            </div>
    <asp:Label ID="labellaptop" runat="server" Text="Your item Quantity is 0"></asp:Label>
        </div>
