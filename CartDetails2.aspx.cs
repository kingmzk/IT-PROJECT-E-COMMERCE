...
{
    public partial class CartDetails2 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (isformvalid())
            {
                ...
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand("Insert into tblCart1(Name,Email,PhoneNo,Company,Comment) Values('" + txtNamess.Text + "','" + txtEmailss.Text + "','" + txtPhoness.Text + "','" + txtCompanyss.Text + "','" + txtCom.Text + "')", con);
                    cmd.ExecuteNonQuery();
                    ...
                    Session["Iphone"] = txtquantity.Text;
                }
                Response.Redirect("~/CartResult2.aspx");
            }
            else
            {
