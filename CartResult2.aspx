<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CartResult2.aspx.cs" Inherits="IT_PROJECT_FOR_CUSTOMER_E_COMMERCE.CartResult2" %>
 ...
 <div class="box">
            ...
            <div class="content">
                ...
                <div class="info">
                    ...
                    <asp:Button ID="btnPhone" class="btn btn-primary btn-lg" runat="server" Text="Sucessfully Added" OnClick="btnPhone_Click"  />
                </div>
            </div>

        <asp:Label ID="lbliphone" runat="server" Text="Your item Quantity is 0"></asp:Label>
        </div>
