<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CartDetails5.aspx.cs" Inherits="IT_PROJECT_FOR_CUSTOMER_E_COMMERCE.CartDetails5" %>
...
<body>
    <form id="form1" runat="server">
        <>
           ...
           <label class="col-xs-11">QuantityNo:</label>
                <div  class="col-xs-11">
               <asp:TextBox ID="txtquantity" runat="server" CssClass="form-control" placeholder="Enter Your Quantity Number"></asp:TextBox>
               </div>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="info">
                      <h3>$50</h3>
                   <!-- <asp:Button ID="btnFoot" class="btn btn-primary btn-lg" runat="server" Text="Add-To-Cart"  />  -->
                    <asp:Button ID="Button2" runat="server"   class="btn btn-primary btn-lg" Text="Add-To-Cart" />
